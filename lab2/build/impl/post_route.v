...
module counter
  ...
  wire [3:0]p_0_in;
  wire [3:0]NLW_numCycles0_carry_CO_UNCONNECTED;
  wire [3:0]NLW_numCycles0_carry__0_CO_UNCONNECTED;
  wire [3:0]NLW_numCycles0_carry__1_CO_UNCONNECTED;
  wire [3:0]NLW_numCycles0_carry__2_CO_UNCONNECTED;
  wire [3:0]NLW_numCycles0_carry__3_CO_UNCONNECTED;
  wire [3:0]NLW_numCycles0_carry__4_CO_UNCONNECTED;
  ...
  CARRY4 numCycles0_carry
       (.CI(\<const0> ),
        .CO({numCycles0_carry_n_0,NLW_numCycles0_carry_CO_UNCONNECTED[2:0]}),
        .CYINIT(numCycles[0]),
  ...
  CARRY4 numCycles0_carry__0
       (.CI(numCycles0_carry_n_0),
        .CO({numCycles0_carry__0_n_0,NLW_numCycles0_carry__0_CO_UNCONNECTED[2:0]}),
        .CYINIT(\<const0> ),
        .DI({\<const0> ,\<const0> ,\<const0> ,\<const0> }),
        .O(data0[8:5]),
        .S(numCycles[8:5]));
  ...
  CARRY4 numCycles0_carry__1
       (.CI(numCycles0_carry__0_n_0),
        .CO({numCycles0_carry__1_n_0,NLW_numCycles0_carry__1_CO_UNCONNECTED[2:0]}),
        .CYINIT(\<const0> ),
        .DI({\<const0> ,\<const0> ,\<const0> ,\<const0> }),
        .O(data0[12:9]),
        .S(numCycles[12:9]));
  ...
  CARRY4 numCycles0_carry__2
       (.CI(numCycles0_carry__1_n_0),
        .CO({numCycles0_carry__2_n_0,NLW_numCycles0_carry__2_CO_UNCONNECTED[2:0]}),
        .CYINIT(\<const0> ),
        .DI({\<const0> ,\<const0> ,\<const0> ,\<const0> }),
        .O(data0[16:13]),
        .S(numCycles[16:13]));
  ...
  CARRY4 numCycles0_carry__3
       (.CI(numCycles0_carry__2_n_0),
        .CO({numCycles0_carry__3_n_0,NLW_numCycles0_carry__3_CO_UNCONNECTED[2:0]}),
        .CYINIT(\<const0> ),
        .DI({\<const0> ,\<const0> ,\<const0> ,\<const0> }),
        .O(data0[20:17]),
        .S(numCycles[20:17]));
  ...
  CARRY4 numCycles0_carry__4
       (.CI(numCycles0_carry__3_n_0),
        .CO({numCycles0_carry__4_n_0,NLW_numCycles0_carry__4_CO_UNCONNECTED[2:0]}),
        .CYINIT(\<const0> ),
        .DI({\<const0> ,\<const0> ,\<const0> ,\<const0> }),
        .O(data0[24:21]),
        .S(numCycles[24:21]));
