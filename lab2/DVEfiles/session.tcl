...
# DVE full session
# Saved on Mon Sep 12 21:20:02 2022
# Designs open: 1
...
gui_show_window -window ${TopLevel.1} -show_state normal -rect {{102 277} {1149 1110}}
...
gui_update_layout -id ${HSPane.1} {{left 0} {top 0} {width 168} {height 563} {dock_state left} {dock_on_new_line true} {child_hier_colhier 140} {child_hier_coltype 100} {child_hier_colpd 0} {child_hier_col1 0} {child_hier_col2 1} {child_hier_col3 -1}}
...
gui_update_layout -id ${DLPane.1} {{left 0} {top 0} {width 168} {height 563} {dock_state left} {dock_on_new_line true} {child_data_colvariable 140} {child_data_colvalue 100} {child_data_coltype 40} {child_data_col1 0} {child_data_col2 1} {child_data_col3 2}}
set Console.1 [gui_create_window -type Console -parent ${TopLevel.1} -dock_state bottom -dock_on_new_line true -dock_extent 175]
gui_set_window_pref_key -window ${Console.1} -key dock_width -value_type integer -value 1048
gui_set_window_pref_key -window ${Console.1} -key dock_height -value_type integer -value 175
gui_set_window_pref_key -window ${Console.1} -key dock_offset -value_type integer -value 0
gui_update_layout -id ${Console.1} {{left 0} {top 0} {width 1047} {height 174} {dock_state bottom} {dock_on_new_line true}}
...
set _session_group_1 counter_testbench
gui_sg_create "$_session_group_1"
set counter_testbench "$_session_group_1"

gui_sg_addsignal -group "$_session_group_1" { {counter_testbench.unnamed$$_0.unnamed$$_1} counter_testbench.clock counter_testbench.ce counter_testbench.LEDS }
...
# Restore C1 time
gui_set_time -C1_only 100000000
...
gui_open_source -id ${Source.1}  -replace -active counter_testbench /home/cc/eecs151/fa22/class/eecs151-afk/fpga_labs_fa22/lab2/sim/counter_testbench.v
